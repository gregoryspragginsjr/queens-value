  ...
  <div class="hero">
    ...
    <div class="hero__inner grid">
      <div class="hero__secondary">
        ...
        <p>Read on to find out why we're worth it, and how our education is personalized and tailored to meet you where you are and help you reach your goals.</p>
      </div>
...
.hero {
  padding: 28px 0 34px;
  background-image:
    linear-gradient(180deg, rgba(0, 32, 91, 0) 67.71%, $navy 100%),
